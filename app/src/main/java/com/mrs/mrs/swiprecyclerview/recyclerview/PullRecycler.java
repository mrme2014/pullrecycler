...
public class PullRecycler extends FrameLayout implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void setUpView(Context context) {
        ...
        emptyTipTitle = (TextView) loadFrameLayout.findViewById(R.id.emptyTipTv);
        ...
        refreshLayout.setColorSchemeResources(R.color.colorAccent, R.color.colorAccent, R.color.colorAccent);
     ...
     * @param color
     */
    public void setEmptyViewIv(boolean showImage, String tip, String titleTip, int color) {
        if (!showImage) {
        ...
        emptyTipTv.setTextSize(12, TypedValue.COMPLEX_UNIT_SP);
    ...
    public boolean isStackFromEnd() {
        return iLayoutmanager.isStackFromEnd();
    }
     ...
     */
    public boolean canScrollVertivcal() {
    ...
    public void keepPositionAfterRefresh(final boolean refresh, final int countBeforeUpdate, boolean scrollDown, boolean active) {
        ...
        if (!isStackFromEnd() && !active) {
            postDelayed(new Runnable() {
                @Override
                public void run() {
                    boolean canScrollVertically = canScrollVertivcal();
