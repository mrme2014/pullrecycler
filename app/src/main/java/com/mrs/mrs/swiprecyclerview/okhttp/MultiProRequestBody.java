 ...
 * 包装的响体，处理进度
 */
public class MultiProRequestBody extends ResponseBody {
    //实际的待包装响应体
     ...
     */
    public MultiProRequestBody(ResponseBody responseBody, ProgressListener progressListener) {
    ...
    public interface ProgressListener {
        ...
        void onProgress(long totalBytesRead, long totalLength, boolean ok);
    }
}